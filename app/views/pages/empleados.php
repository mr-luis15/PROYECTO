...
<div class="main">
    ...
    <div class="table-responsive">
        <button class="btn btn-primary" style="margin: 3vh 0vh 3vh 0vh;" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalUsuarios"><i class="fas fa-user-plus"></i> Agregar empleado</button>
        <table>
            <thead>
                <tr>
                    <td>Id</td>
